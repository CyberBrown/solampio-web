...
export const useArticle = routeLoader$(async ({ params, platform, status }) => {
  try {
    ...
    if (!article || article.section !== 'guides') {
      status(404);
      return { article: null, related: [] };
    }
      ...
      <div class="bg-white min-h-screen">
        <section class="py-16">
          <div class="container mx-auto px-4 text-center">
            <h1 class="font-heading font-bold text-2xl text-gray-800 mb-4">Guide Not Found</h1>
            <p class="text-gray-500 mb-6">The guide you're looking for doesn't exist or has been moved.</p>
            <Link href="/learn/archives/guides/" class="text-[#5974c3] font-semibold hover:underline">
              Browse all Guides
            </Link>
          </div>
        </section>
  ...
  return (
    <div class="bg-white min-h-screen">
      ...
      <section class="bg-[#5974c3] py-8">
        <div class="container mx-auto px-4">
          <nav class="text-sm mb-4">
            ...
            <span class="text-white/40 mx-2">/</span>
            <Link href="/learn/archives/guides/" class="text-white/60 hover:text-white">Guides</Link>
          </nav>
            ...
            <div class="grid md:grid-cols-3 gap-4 max-w-4xl">
              {related.map((relatedArticle: Article) => (
                <Link
                  ...
                  class="bg-white rounded-lg border border-gray-200 p-4 hover:shadow-md hover:border-[#5974c3] transition-all group"
                >
      ...
      <section class="py-6 border-t border-gray-100">
        <div class="container mx-auto px-4">
          <Link href="/learn/archives/guides/" class="text-[#5974c3] text-sm font-semibold hover:underline inline-flex items-center gap-1">
...
export const head: DocumentHead = ({ resolveValue }) => {
  ...
  return {
    title: article ? `${article.title} | Guides | Solamp` : 'Guide Not Found | Solamp',
    meta: [
      {
        name: 'description',
        content: article?.excerpt || 'Step-by-step buying guides and how-to resources from the Cleantech Archives.',
      },
    ],
  };
};

...
const ProductPage = component$<{ data: PageData }>(({ data }) => {
  ...
  return (
    <div>
      ...
      {(product.description_html || parentProduct?.description_html || product.description_clean || parentProduct?.description_clean || product.description || parentProduct?.description) && (
            ...
            <div class="max-w-3xl">
              ...
              <div
                ...
                dangerouslySetInnerHTML={(() => {
                  // 1. First priority: LLM-formatted HTML description
                  const descHtml = product.description_html || parentProduct?.description_html;
                  if (descHtml) {
                    return descHtml;
                  }

                  // 2. Second priority: Transform description_clean with regex
                  ...
                  // 3. Fallback to raw description HTML

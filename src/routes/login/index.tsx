    ...
    <div class="bg-[#f1f1f2] min-h-screen flex items-center justify-center py-12 px-4">
      <div class="max-w-md w-full">
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-8 shadow-lg">
          <form>
            ...
            <div class="flex items-center justify-between mb-6">
              ...
              <a href="#" class="text-sm text-[#5974c3] hover:underline">Forgot password?</a>
            </div>
            <button
              type="submit"
        ...
        <p class="text-center mt-6 text-gray-600">
          ...
          <Link href="/register/" class="text-[#5974c3] font-bold hover:underline">
            Create one
          </Link>
        </p>
...
export const head: DocumentHead = {
  title: 'Sign In | Solamp Solar & Energy Storage',
  meta: [
    {
      name: 'description',
      content: 'Sign in to your Solamp account to manage orders, quotes, and saved carts.',
    },
  ],
};
